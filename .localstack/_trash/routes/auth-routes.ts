...
authRouter.post('/login',
    ...
    async (req:Request, res:Response, next:NextFunction) => await authController.userLogin(req,res,next));
 ...
 *         description: Internal Server Error
 */
authRouter.get('/logout', async (req:Request, res:Response, next:NextFunction)  => await authController.userLogout(req,res,next));
 ...
 *         description: Internal Server Error
 */
authRouter.post('/signup', async (req:Request, res:Response, next:NextFunction)  => await authController.userSignUp(req,res,next));
