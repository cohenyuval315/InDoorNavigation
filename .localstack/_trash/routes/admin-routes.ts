...
/**
 * @swagger
 * /admin/processing/map/:buildingId/:version
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
...
/**
 * @swagger
 * /admin/processing/map/:buildingId
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
...
/**
 * @swagger
 * /admin/processing/routes/:buildingId/titles
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
...
/**
 * @swagger
 * /admin/processing/route/:buildingId
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
...
/**
 * @swagger
 * /admin/processing/route/:buildingId/:routeName
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
...
/**
 * @swagger
 * /admin/processing/routes/:buildingId
 *   post:
 *     summary: get building graph data
 *     description: 
 *     responses:
