...
const BuildingCard = ({building}) => {
    ...
    const directionsAvailable = isMapServiceInstalled 
    const buildingDetails = building.details;
    const BuildingOpenStatus = building.openStatus
    ...
    const onDirectionPress = async () => {
        const hasMapProvider= await isMapServiceAvailable();
        if (hasMapProvider){
            openMap(country, state, city, street, streetNumber, postalCode);
        }else{
            Alert.alert('No Map Provider Installed', 'cannot find directions');
        }
    ...
    const handleOnBuildingMapPress = () => {
        dispatch(fetchBuildingByMapId(building.id))
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    {building.availableActivities.map(([activity, _]) => (
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    {building.availableAccessibility.map(([feature, _]) => (
                            ...
                            <SafeAreaView style={{
                                ...
                                <View style={{
                                    ...
                                    {isOpenHours ? (
                                            ...
                                            {buildingDetails.scheduleString}
                                            </Text> 
                                        )}
                                    </TouchableOpacity>        
                                </View>
