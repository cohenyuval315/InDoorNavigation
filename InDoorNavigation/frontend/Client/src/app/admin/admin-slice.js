...
export const uploadProcessingRoute = createAsyncThunk(
  ...
  async (args,{rejectWithValue}) => {
    try{
      ...
      console.log(typeof buildingId,buildingId,typeof data,data);
      ...
      console.log("error in uploading route",error)
    }
  },
)
export const uploadProcessingMap = createAsyncThunk(
  ...
  async (args,{rejectWithValue}) => {
    try{
      ...
      console.log("error in upload points",error)
    }
...
const adminSlice = createSlice({
    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(uploadProcessingRoute.rejected , (state,action) => {
          // state.processingError = action.payload;
          console.log("REJECTED ROUTE")
          state.processingStatus = Status.FAILED
        })

        .addCase(uploadProcessingRoute.pending , (state,action) => {
          // state.processingError = action.payload;
          state.processingStatus = Status.PENDING
          console.log("PENDING ROUTE")
        })

        .addCase(uploadProcessingRoute.fulfilled , (state,action) => {
          // state.processingError = action.payload;
