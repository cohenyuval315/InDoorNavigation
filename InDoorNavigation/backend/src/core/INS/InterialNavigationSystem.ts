...
import { AHRS } from "./AHRS/AHRS.js";
import { IMU } from "./IMU/IMU.js";
import { StepDetection } from "./step-detection/StepDetection.js";
import { StepLengthEstimation } from "./step-length-estimation/StepLengthEstimation.js";
...
export class InterialNavigationSystem {
    ...
    ) : Promise<InterialNavigationSystemResult> {
        const {
            magnetometer,
            accelerometer,
            gyroscope,
