...
public class AndroidSensor extends ReactContextBaseJavaModule implements SensorEventListener {
  ...
  public AndroidSensor(ReactApplicationContext reactContext, String sensorName, int sensorType) {
    super(reactContext);
