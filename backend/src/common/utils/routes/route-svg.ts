...
export const createRouteSVG = (nodes: MapNode[],edges: MapEdge[],mapFloors: MapFloor[]): { floor:Number, floorRouteSVG:string }[] => {
    const svgs: { floor: number, floorRouteSVG: string }[] = [];
