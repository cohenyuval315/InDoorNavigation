...
export function minkowskiDistance(point1, point2, p) {
...
export function jaccardDistance(set1, set2) {
...
export function euclideanDistance3D(point1, point2) {
...
export function manhattanDistance3D(point1, point2) {
    // Assuming points are arrays with [x, y, z] coordinates
    const dx = Math.abs(point2[0] - point1[0]);
    const dy = Math.abs(point2[1] - point1[1]);
...
export function cosineDistance3D(vector1, vector2) {
...
export function jaccardDistance3D(set1, set2) {
...
export function hammingDistance3D(point1, point2) {
    if (point1.length !== point2.length) {
        throw new Error("Points must be of the same dimension");
    }
    let distance = 0;
...
export function minkowskiDistance3D(point1, point2, p) {
    if (point1.length !== point2.length) {
        throw new Error("Points must be of the same dimension");
    }
    let sum = 0;
