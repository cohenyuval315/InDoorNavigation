 ...
 */
userRouter.get('/buildings', async (req, res, next) => await BuildingController.getAllBuildingsData(req,res,next));
 ...
 *         description: Internal Server Error
 */
userRouter.get('/buildings/map/:id', async (req, res, next) => await BuildingController.getBuildingMapData(req,res,next));
 ...
 *         description: Internal Server Error
 */
userRouter.post('/navigation/:id', async (req, res, next) => await navigationController.getNavigationRoute(req,res,next));
 ...
 *         description: Internal Server Error
 */
userRouter.post('/system', async (req, res, next) => await userController.getUserSystemConfiguration(req,res,next));
 ...
 *         description: Internal Server Error
 */
userRouter.get('/account', async (req, res, next) => await userController.getUserAccount(req,res,next));
 ...
 *         description: Internal Server Error
 */
userRouter.put('/profile',async (req, res, next) => await userController.updateUserProfile(req,res,next));
